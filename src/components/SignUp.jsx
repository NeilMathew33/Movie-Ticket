...
<h4 className='text-center'>User Sign Up</h4>
        ...
        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
          <label htmlFor="" className="form-label">Address of Theater</label>
         <textarea name="addressoftheater" id="" className="form-control" value={input.addressoftheater} onChange={handleInput}></textarea>
        </div>
        <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
          <label htmlFor="" className="form-label">Movie</label>
          <input type="text" className="form-control" name="movie" value={input.movie} onChange={handleInput} />
        </div>
        <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
          <label htmlFor="" className="form-label">Movie Theater Number</label>
          <input type="text" className="form-control" name="movietheaternumber" value={input.movietheaternumber} onChange={handleInput} />
        </div>
        <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
        ...
        <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
          <label htmlFor="" className="form-label">Movie Seat</label>
          <input type="text" className="form-control" name="movieseat" value={input.movieseat} onChange={handleInput} />
        </div>
        <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
